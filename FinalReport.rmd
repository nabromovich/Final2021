...
```
According to the Chi-Squared test, the p-value for women is .0006. This number indicates that we need to reject the null hypothesis and that there is a difference between the women that took the placebo and those whom took the drug.

The Effectiveness of the Covid91 vaccine in women is 40.4% with a confidence level of 35.1 to 55.   
...
```
The p-value of the part of the study is 0.002273.  This number indicates that we need to reject the null hypothesis and that there is a difference between the drug users that took the placebo and those whom took the drug.


The effectiveness of the Covid91 vaccine among drug users is 64.7% with a confidence level of 54 to 125. 
...
Usershighprob <- Usershigh / (1+Userslow)
...
The numerical summery of the gays group backs up the data we see in the box plot run earlier.  71% of the gays that took the Covid91 vaccine still ended up getting the virus while the 30% of gays that took the placebo got sick. 
...
```
The gays data shows a p-value of (5.741e-06).

The Covid91 vaccine effectiveness in the gays group is very low at only 28.6% effective with a confidence level of 20.5 to 48.6. 
...
Gayshighprob <- Gayshigh / (1+Gayslow)
